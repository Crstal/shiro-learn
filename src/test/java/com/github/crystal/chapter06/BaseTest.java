package com.github.crystal.chapter06;
...
import com.github.crystal.chapter06.service.PermissionService;
import com.github.crystal.chapter06.service.PermisssionServiceImpl;
import com.github.crystal.chapter06.service.RoleService;
import com.github.crystal.chapter06.service.RoleServiceImpl;
import com.github.crystal.chapter06.service.UserService;
import com.github.crystal.chapter06.service.UserServiceImpl;

public class BaseTest {

	protected PermissionService permissionService = new PermisssionServiceImpl();
    ...
    public void setUp() {
        ...
        //4、新增用户
        u1 = new User("crystal", password);
        u2 = new User("barry", password);
        u3 = new User("karry", password);
        u4 = new User("shawn", password);
