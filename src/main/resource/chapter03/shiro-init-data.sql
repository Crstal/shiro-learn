...
insert into users(username, password, password_salt) values('crystal', '123', null);
insert into user_roles(username, role_name) values('crystal', 'role1');
insert into user_roles(username, role_name) values('crystal', 'role2');
