...
public class CodecAndCryptoTest {
	...
	public void testCodecSupport() {
		String str = "hello";
		byte[] codec = CodecSupport.toBytes(str, "utf-8");
		String str2 = CodecSupport.toString(codec, "utf-8");
		Assert.assertEquals(str, str2);
	}
	...
	public void testRandom() {
		...
		System.out.println(random.nextBytes().toHex());
	}
	...
	public void testMD5() {
		...
		System.out.println(new Md5Hash(str, salt, 2).toString());//两次散列
	}
	...
	public void testSha256() {
		String str = "hello";
		String salt = "123";
		String sha256 = new Sha256Hash(str, salt).toString();  //MessageDigest
    ...
    public void testSimpleHash() {
    	String str = "hello";
    	String salt = "123";
    	String simple = new SimpleHash("SHA-1", str, salt).toString();
    ...
    public void testHashService() {
    	...
    	HashRequest request = new HashRequest.Builder()
    		.setAlgorithmName("MD5").setSource("hello").setSalt("123").setIterations(2).build();
